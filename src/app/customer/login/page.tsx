...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Simulate API call
    setTimeout(() => {
      // Save user data to localStorage (in production, this would be a proper auth)
      const user = {
        id: 'cust_' + Date.now(),
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        <div className="text-center">
          ...
          <p className="mt-2 text-center text-sm text-gray-600">
            Or{' '}
            <Link href="/customer/signup" className="font-medium text-teal-600 hover:text-teal-500">
